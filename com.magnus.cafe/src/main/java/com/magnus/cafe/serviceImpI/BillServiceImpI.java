...
import com.magnus.cafe.JWT.JwtFilter;
...
@Slf4j
@Service
public class BillServiceImpI implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if (validateRequestMap(requestMap)) {
                ...
                PdfWriter.getInstance(document, new FileOutputStream(CafeContents.STORE_LOCATION + "\\" + fileName + ".pdf" ));

                document.open();
                setRectangleInPdf(document);


                Paragraph chunk = new Paragraph("Magnus Cafe", getFont("Header"));
                ...
                + "Thank you for ordering", getFont("Data"));
                document.add(footer);
                document.close();
    ...
    public ResponseEntity<byte[]> getPdf(Map<String, Object> requestMap) {
        ...
        try {
            ...
            String filePath = CafeContents.STORE_LOCATION + "\\" + (String) requestMap.get("uuid") + ".pdf";
